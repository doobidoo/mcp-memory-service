...
class HealthChecker:
    ...
    async def test_memory_operations(self):
        ...
        try:
            ...
            memory = Memory(
                content=content, content_hash=generate_content_hash(content), tags=["health", "check"], memory_type="test"
            )
    ...
    async def test_vector_search(self):
        ...
        try:
            ...
            test_memories = ["Python programming is fun", "JavaScript development tools", "Database design patterns"]

            for content in test_memories:
                memory = Memory(
                    content=content, content_hash=generate_content_hash(content), tags=["programming"], memory_type="test"
                )
    ...
    def test_environment(self):
        ...
        required_vars = {"MCP_MEMORY_STORAGE_BACKEND": "sqlite_vec"}
...
async def main():
    ...
    sum(1 for _, status, _ in checker.results if status in ["FAIL", "ERROR"])
