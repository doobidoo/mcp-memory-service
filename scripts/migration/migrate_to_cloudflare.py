...
async def main():
    ...
    export_parser.add_argument("--source", choices=["sqlite_vec", "chroma"], required=True, help="Source backend type")
    export_parser.add_argument("--source-path", required=True, help="Path to source database")
    ...
    migrate_parser.add_argument("--source", choices=["sqlite_vec", "chroma"], required=True, help="Source backend type")
    migrate_parser.add_argument("--source-path", required=True, help="Path to source database")
    ...
    try:
        if args.command == "export":
            success = await migrator.export_to_file(args.source, args.source_path, args.output)
