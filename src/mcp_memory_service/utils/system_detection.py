...
class SystemInfo:
    ...
    def _check_mps_available(self) -> bool:
        ...
        try:
            ...
            try:
                output = subprocess.check_output(["system_profiler", "SPDisplaysDataType"], stderr=subprocess.DEVNULL).decode(
                    "utf-8"
                )
    ...
    def _check_rocm_available(self) -> bool:
        ...
        try:
            ...
            try:
                output = subprocess.check_output(["rocminfo"], stderr=subprocess.DEVNULL).decode("utf-8")
    ...
    def _detect_rosetta(self) -> bool:
        ...
        try:
            ...
            output = (
                subprocess.check_output(["sysctl", "-n", "sysctl.proc_translated"], stderr=subprocess.DEVNULL)
                .decode("utf-8")
                .strip()
            )
            return output == "1"
    ...
    def get_optimal_model(self) -> str:
        ...
        if self.accelerator in [AcceleratorType.CUDA, AcceleratorType.MPS] and self.memory_gb > 8:
